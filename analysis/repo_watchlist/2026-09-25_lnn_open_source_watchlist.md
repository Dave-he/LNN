---
title: LNN 开源生态观察 - 2026-09-25
date: 2026-09-25
tags: [LNN, repo-watchlist, automation]
---

# LNN 开源生态观察 - 2026-09-25

## GitHub 仓库
### [QilinLi147/LiquidFocus](https://github.com/QilinLi147/LiquidFocus)
- 更新：2026-09-24
- Star / Fork：0 / 0
- 语言：Python
- Topics：未标注
- 说明：Liquid neural networks for EEG emotion recognition with dual-timescale fusion and prediction-decoupled hierarchical evidence localisation.
...
### [trymirai/LFM2.5-2.6B-L](https://huggingface.co/trymirai/LFM2.5-2.6B-L)
- 更新：2026-09-24
- 下载 / Likes：648 / 0
- 任务：text-generation
- Tags：uzu, safetensors, mirai, 8-bit, text-generation, base_model:LiquidAI/LFM2.5-2.6B, base_model:quantized:LiquidAI/LFM2.5-2.6B, license:other

### [trymirai/LFM2.5-230M-L](https://huggingface.co/trymirai/LFM2.5-230M-L)
- 更新：2026-09-24
- 下载 / Likes：643 / 0
- 任务：text-generation
- Tags：uzu, safetensors, mirai, 8-bit, text-generation, base_model:LiquidAI/LFM2.5-230M, base_model:quantized:LiquidAI/LFM2.5-230M, license:other

### [trymirai/LFM2.5-350M-L](https://huggingface.co/trymirai/LFM2.5-350M-L)
- 更新：2026-09-24
- 下载 / Likes：621 / 0
- 任务：text-generation
...
- 下载 / Likes：37 / 10
- 任务：image-text-to-text
- Tags：sglang, safetensors, qwen3, speculative-decoding, dspark, lfm2, lfm2-vl, draft-model

### [LiquidAI/LFM2.5-VL-3B-DSpark-GGUF](https://huggingface.co/LiquidAI/LFM2.5-VL-3B-DSpark-GGUF)
- 更新：2026-09-24
- 下载 / Likes：5 / 7
- 任务：image-text-to-text
- Tags：llama.cpp, gguf, speculative-decoding, dspark, lfm2, lfm2-vl, draft-model, image-text-to-text

### [Synaptics/LiquidAI-LFM2.5-350M-w8a8-torq](https://huggingface.co/Synaptics/LiquidAI-LFM2.5-350M-w8a8-torq)
- 更新：2026-09-24
- 下载 / Likes：2 / 0
- 任务：text-generation
- Tags：lfm2, torq, synaptics, sl2619, npu, edge, lfm2.5, text-generation

### [Synaptics/LiquidAI-LFM2.5-230M-w8a8-torq](https://huggingface.co/Synaptics/LiquidAI-LFM2.5-230M-w8a8-torq)
- 更新：2026-09-24
- 下载 / Likes：2 / 0
- 任务：text-generation
- Tags：lfm2, torq, synaptics, sl2619, npu, edge, lfm2.5, text-generation
...
- 下载 / Likes：321553 / 222
- 任务：text-generation
- Tags：safetensors, gguf, liquid, lfm2.5, edge, llama.cpp, text-generation, en

### [LiquidAI/LFM2.5-350M-GGUF](https://huggingface.co/LiquidAI/LFM2.5-350M-GGUF)
- 更新：2026-09-22
- 下载 / Likes：72124 / 103
- 任务：text-generation
- Tags：safetensors, gguf, liquid, lfm2, edge, llama.cpp, text-generation, en
