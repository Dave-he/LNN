---
title: LNN 开源生态观察 - 2026-08-17
date: 2026-08-17
tags: [LNN, repo-watchlist, automation]
---

# LNN 开源生态观察 - 2026-08-17
...
### [hanija0/Skin-Lesion-Classification-Using-Liquid-Neural-Networks](https://github.com/hanija0/Skin-Lesion-Classification-Using-Liquid-Neural-Networks)
- 更新：2026-08-16
- Star / Fork：0 / 0
- 语言：Jupyter Notebook
- Topics：未标注
...
- Star / Fork：0 / 0
- 语言：unknown
- Topics：computer-vision, edge-ai, embodied-ai, large-language-models, liquid-neural-networks, mapping, on-device-ai, raspberry-pi
- 说明：Open-source Raspberry Pi 5 robotic rover for mapping, computer vision, and voice control, powered by on-device language models and liquid neural networks.
...
### [visible-cx/LFM2.5-VL-3B-CoreAI](https://huggingface.co/visible-cx/LFM2.5-VL-3B-CoreAI)
- 更新：2026-08-17
- 下载 / Likes：0 / 0
- 任务：image-text-to-text
- Tags：coreai, core-ai, aimodel, apple-silicon, on-device, quantized, int4, int8

### [visible-cx/LFM2.5-VL-450M-CoreAI](https://huggingface.co/visible-cx/LFM2.5-VL-450M-CoreAI)
- 更新：2026-08-17
- 下载 / Likes：0 / 0
- 任务：image-text-to-text
- Tags：coreai, core-ai, aimodel, apple-silicon, on-device, quantized, int8, vision-language

### [visible-cx/LFM2.5-8B-A1B-CoreAI](https://huggingface.co/visible-cx/LFM2.5-8B-A1B-CoreAI)
- 更新：2026-08-17
- 下载 / Likes：0 / 0
- 任务：text-generation
- Tags：coreai, core-ai, aimodel, apple-silicon, on-device, quantized, int8, moe

### [visible-cx/LFM2.5-2.6B-CoreAI](https://huggingface.co/visible-cx/LFM2.5-2.6B-CoreAI)
- 更新：2026-08-17
- 下载 / Likes：0 / 0
- 任务：text-generation
- Tags：coreai, core-ai, aimodel, apple-silicon, on-device, quantized, int8, lfm2.5

### [visible-cx/LFM2.5-1.2B-CoreAI](https://huggingface.co/visible-cx/LFM2.5-1.2B-CoreAI)
- 更新：2026-08-17
- 下载 / Likes：0 / 0
- 任务：text-generation
- Tags：coreai, core-ai, aimodel, apple-silicon, on-device, quantized, int8, lfm2.5

### [visible-cx/LFM2.5-350M-CoreAI](https://huggingface.co/visible-cx/LFM2.5-350M-CoreAI)
- 更新：2026-08-17
- 下载 / Likes：0 / 0
- 任务：text-generation
- Tags：coreai, core-ai, aimodel, apple-silicon, on-device, quantized, int8, lfm2.5

### [useful-quants/LFM2.5-VL-3B-NVFP4-FP8-MinVRAM](https://huggingface.co/useful-quants/LFM2.5-VL-3B-NVFP4-FP8-MinVRAM)
- 更新：2026-08-17
- 下载 / Likes：0 / 0
- 任务：image-text-to-text
- Tags：safetensors, lfm2_vl, liquid, lfm2.5, multimodal, nvfp4, fp8, vllm

### [useful-quants/LFM2.5-VL-3B-NVFP4-FP8-Mixed](https://huggingface.co/useful-quants/LFM2.5-VL-3B-NVFP4-FP8-Mixed)
- 更新：2026-08-17
- 下载 / Likes：0 / 0
- 任务：image-text-to-text
- Tags：safetensors, lfm2_vl, liquid, lfm2.5, multimodal, nvfp4, fp8, vllm
