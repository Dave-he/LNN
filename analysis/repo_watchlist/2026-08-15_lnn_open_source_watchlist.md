---
title: LNN 开源生态观察 - 2026-08-15
date: 2026-08-15
tags: [LNN, repo-watchlist, automation]
---

# LNN 开源生态观察 - 2026-08-15
...
### [AyoubChLin/lfm2.5-2.6b-fable5-coding-agent](https://huggingface.co/AyoubChLin/lfm2.5-2.6b-fable5-coding-agent)
- 更新：2026-08-15
- 下载 / Likes：430 / 4
- 任务：text-generation
- Tags：transformers, safetensors, lfm2, text-generation, full-parameter-fine-tuning, supervised-fine-tuning, assistant-only-loss, tool-use

### [yuyijiong/LFM2.5-Encoder-350M-corpus-cleaner](https://huggingface.co/yuyijiong/LFM2.5-Encoder-350M-corpus-cleaner)
- 更新：2026-08-15
- 下载 / Likes：12 / 1
- 任务：token-classification
- Tags：transformers, safetensors, lfm2, token-classification, data-cleaning, custom_code, en, zh

### [rafmacalaba/lfm2.5-350M-datause-provenance-onnx](https://huggingface.co/rafmacalaba/lfm2.5-350M-datause-provenance-onnx)
- 更新：2026-08-15
- 下载 / Likes：0 / 0
- 任务：unknown
- Tags：onnx, region:us

### [rafmacalaba/lfm2.5-350M-datause-provenance](https://huggingface.co/rafmacalaba/lfm2.5-350M-datause-provenance)
- 更新：2026-08-15
- 下载 / Likes：0 / 0
- 任务：text-generation
- Tags：safetensors, lfm2, data-use, provenance, sft, lora, text-generation, conversational

### [rafmacalaba/lfm2-provenance-smoke](https://huggingface.co/rafmacalaba/lfm2-provenance-smoke)
- 更新：2026-08-15
- 下载 / Likes：0 / 0
- 任务：text-generation
- Tags：safetensors, lfm2, data-use, provenance, sft, lora, text-generation, conversational

### [AbhishekG711/LFM2.5-2.6B-Insight-Extractor](https://huggingface.co/AbhishekG711/LFM2.5-2.6B-Insight-Extractor)
- 更新：2026-08-15
- 下载 / Likes：0 / 0
- 任务：text-generation
- Tags：transformers, safetensors, lfm2, text-generation, text-generation-inference, unsloth, conversational, en

### [ai4data/lfm2.5-Encoder-350M-datause](https://huggingface.co/ai4data/lfm2.5-Encoder-350M-datause)
- 更新：2026-08-15
- 下载 / Likes：0 / 0
- 任务：token-classification
- Tags：safetensors, lfm2, ner, bio, data-use, token-classification, custom_code, license:apache-2.0

### [LiquidAI/LFM2.5-2.6B-Base](https://huggingface.co/LiquidAI/LFM2.5-2.6B-Base)
- 更新：2026-08-14
- 下载 / Likes：11673 / 43
- 任务：text-generation
...
- 下载 / Likes：561 / 16
- 任务：image-text-to-text
- Tags：transformers.js, onnx, lfm2_vl, image-text-to-text, liquid, lfm2, lfm2-vl, edge
...
### [LiquidAI/LFM2.5-1.2B-Instruct-MLX-6bit](https://huggingface.co/LiquidAI/LFM2.5-1.2B-Instruct-MLX-6bit)
- 更新：2026-08-12
- 下载 / Likes：310 / 10
- 任务：text-generation
- Tags：mlx, safetensors, lfm2, liquid, lfm2.5, edge, text-generation, conversational
