---
title: LNN 开源生态观察 - 2026-09-19
date: 2026-09-19
tags: [LNN, repo-watchlist, automation]
---

# LNN 开源生态观察 - 2026-09-19
...
## Hugging Face 模型
### [experimentalmachines/LFM2.5-1.2B-Instruct-ExecuTorch](https://huggingface.co/experimentalmachines/LFM2.5-1.2B-Instruct-ExecuTorch)
- 更新：2026-09-18
- 下载 / Likes：53 / 0
- 任务：text-generation
- Tags：executorch, android, on-device, openweights, xnnpack, text-generation, base_model:LiquidAI/LFM2.5-1.2B-Instruct, base_model:quantized:LiquidAI/LFM2.5-1.2B-Instruct

### [kadirnar/LFM2.5-Audio-1.5B-hf](https://huggingface.co/kadirnar/LFM2.5-Audio-1.5B-hf)
- 更新：2026-09-18
- 下载 / Likes：0 / 0
- 任务：audio-to-audio
- Tags：transformers, safetensors, lfm2_audio, text-generation, lfm2-audio, automatic-speech-recognition, text-to-speech, speech-to-speech

### [mradermacher/LFM2.5-1.2B-Wolof-Instruct-GGUF](https://huggingface.co/mradermacher/LFM2.5-1.2B-Wolof-Instruct-GGUF)
- 更新：2026-09-18
- 下载 / Likes：0 / 0
- 任务：unknown
- Tags：transformers, gguf, en, base_model:mamelles/LFM2.5-1.2B-Wolof-Instruct, base_model:quantized:mamelles/LFM2.5-1.2B-Wolof-Instruct, endpoints_compatible, region:us, conversational

### [mradermacher/LFM2.5-8B-A1B-Hermes-Agentic-Coder-Abliterated-v2-GGUF](https://huggingface.co/mradermacher/LFM2.5-8B-A1B-Hermes-Agentic-Coder-Abliterated-v2-GGUF)
- 更新：2026-09-18
- 下载 / Likes：0 / 1
- 任务：unknown
- Tags：transformers, gguf, duo-neural, agentic, coding, function-calling, hermes, liquid-foundation-model

### [Solshine/lfm2.5-2.6b-nla-L21-av-priordev-relabel-v2](https://huggingface.co/Solshine/lfm2.5-2.6b-nla-L21-av-priordev-relabel-v2)
- 更新：2026-09-18
- 下载 / Likes：0 / 0
- 任务：text-generation
- Tags：peft, safetensors, natural-language-autoencoder, nla, interpretability, mechanistic-interpretability, lfm2, consumer-gpu

### [mamelles/LFM2.5-350M-Wolof-CPT](https://huggingface.co/mamelles/LFM2.5-350M-Wolof-CPT)
- 更新：2026-09-18
- 下载 / Likes：0 / 0
- 任务：text-generation
- Tags：transformers, safetensors, lfm2, text-generation, conversational, base_model:LiquidAI/LFM2.5-350M-Base, base_model:finetune:LiquidAI/LFM2.5-350M-Base, endpoints_compatible

### [mamelles/LFM2.5-350M-Wolof-Instruct](https://huggingface.co/mamelles/LFM2.5-350M-Wolof-Instruct)
- 更新：2026-09-18
- 下载 / Likes：0 / 0
- 任务：text-generation
- Tags：transformers, safetensors, lfm2, text-generation, conversational, base_model:LiquidAI/LFM2.5-350M-Base, base_model:finetune:LiquidAI/LFM2.5-350M-Base, endpoints_compatible

### [mamelles/LFM2.5-Wolof-Tokenizer-lfm25-wolof-ext-2000](https://huggingface.co/mamelles/LFM2.5-Wolof-Tokenizer-lfm25-wolof-ext-2000)
- 更新：2026-09-18
- 下载 / Likes：0 / 0
- 任务：unknown
- Tags：region:us
...
- 下载 / Likes：29156 / 64
- 任务：image-text-to-text
- Tags：gguf, liquid, lfm2, lfm2-vl, edge, lfm2.5, lfm2.5-vl, llama.cpp
