# Tox21-styled GraphLNNPredictor Smoke — 2026-06-05_011202
...
- 模型: graph_feat=24 hidden=32 | epoch=5 batch=32 lr=0.003 seed=123
- 类平衡: train +50.0% / val +50.0%

## 结果
| Backbone | 参数量 | Val acc | Val AUC | 训练秒 | 推理样本/秒 |
|---|---:|---:|---:|---:|---:|
| `cfc` | 6,377 | 70.31% | 0.7749 | 2.09 | 3147 |
| `ltc` | 4,585 | 68.75% | 0.7683 | 1.57 | 5232 |
| `gru` | 6,441 | 68.75% | 0.7642 | 1.46 | 2629 |
| `liquid_tad` | 16,105 | 50.00% | 0.7605 | 7.76 | 1653 |
...
JSON: `analysis/molecular/2026-06-05_011202_tox21_styled_graph_lnn.json`
