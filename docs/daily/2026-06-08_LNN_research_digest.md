...
| 更新 | 仓库 | Star | 语言 | 说明 |
|---|---|---:|---|---|
| 2026-06-07 | [Sum-Outman/Self-LNN](https://github.com/Sum-Outman/Self-LNN) | 1 | C | Self AGI System（Self AGI robot System）.自主通用人工智能系统（自主通用人工智能机器人系统）。 AI capable of perceiving the real world。能够感知真实世界的人工智能。 Liquid Neural Network, C language vers… |
| 2026-06-07 | [patel-om/liquid-neural-networks](https://github.com/patel-om/liquid-neural-networks) | 0 |  |  |
| 2026-06-07 | [heimdilon/sncp-ppo-crowdnav](https://github.com/heimdilon/sncp-ppo-crowdnav) | 0 | Python | PPO + LTC (Liquid Time Constant) crowd-aware navigation for TurtleBot3 Waffle. 5-phase curriculum, multi-scenario holdout, clipped value loss. Includes Colab n… |
...
| 更新 | 模型 | 下载 | Likes | 任务 |
|---|---|---:|---:|---|
| 2026-06-07 | [LiquidAI/LFM2.5-Audio-1.5B-JP-GGUF](https://huggingface.co/LiquidAI/LFM2.5-Audio-1.5B-JP-GGUF) | 1011 | 18 | audio-to-audio |
| 2026-06-07 | [reaperdoesntknow/LFM2.5-1.2B-Distilled-SFT](https://huggingface.co/reaperdoesntknow/LFM2.5-1.2B-Distilled-SFT) | 525 | 0 | text-generation |
| 2026-06-07 | [reaperdoesntknow/LFM2.5-8B-A1B-Opus-Distil](https://huggingface.co/reaperdoesntknow/LFM2.5-8B-A1B-Opus-Distil) | 249 | 5 | text-generation |
| 2026-06-07 | [akiFQC/LFM2.5-1.2B-JP-202606-Conf-Extract](https://huggingface.co/akiFQC/LFM2.5-1.2B-JP-202606-Conf-Extract) | 22 | 0 | text-generation |
| 2026-06-07 | [vsuhas9/lfm2-vl-denm](https://huggingface.co/vsuhas9/lfm2-vl-denm) | 0 | 0 | image-text-to-text |
| 2026-06-07 | [mradermacher/LFM2.5-8B-A1B-heretic-i1-GGUF](https://huggingface.co/mradermacher/LFM2.5-8B-A1B-heretic-i1-GGUF) | 0 | 0 |  |
| 2026-06-07 | [316usman/LFM2.5-1.2B-Instruct-3-epochs-research_mashqa_webmd-16a-16r-fp16](https://huggingface.co/316usman/LFM2.5-1.2B-Instruct-3-epochs-research_mashqa_webmd-16a-16r-fp16) | 0 | 0 |  |
| 2026-06-07 | [mradermacher/LFM2.5-8B-A1B-heretic-GGUF](https://huggingface.co/mradermacher/LFM2.5-8B-A1B-heretic-GGUF) | 0 | 0 |  |
| 2026-06-07 | [RikkaBotan/LFM2.5-Audio-1.5B-JP-change-nyan-2](https://huggingface.co/RikkaBotan/LFM2.5-Audio-1.5B-JP-change-nyan-2) | 0 | 1 |  |
| 2026-06-07 | [akiFQC/LFM2.5-1.2B-JP-202606-Conf-Extract-GGUF](https://huggingface.co/akiFQC/LFM2.5-1.2B-JP-202606-Conf-Extract-GGUF) | 0 | 0 |  |
| 2026-06-06 | [LiquidAI/LFM2.5-VL-450M-Extract](https://huggingface.co/LiquidAI/LFM2.5-VL-450M-Extract) | 1495 | 45 | image-text-to-text |
| 2026-06-05 | [LiquidAI/LFM2.5-8B-A1B](https://huggingface.co/LiquidAI/LFM2.5-8B-A1B) | 118326 | 540 | text-generation |
