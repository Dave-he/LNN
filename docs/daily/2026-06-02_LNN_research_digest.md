...
| 2026-06-01 | [Sum-Outman/Self-LNN](https://github.com/Sum-Outman/Self-LNN) | 1 | C | Self AGI System（Self AGI robot System）.自主通用人工智能系统（自主通用人工智能机器人系统）。 AI capable of perceiving the real world。能够感知真实世界的人工智能。 Liquid Neural Network, C language vers… |
| 2026-06-01 | [heimdilon/sncp-ppo-crowdnav](https://github.com/heimdilon/sncp-ppo-crowdnav) | 0 | Python | PPO + LTC (Liquid Time Constant) crowd-aware navigation for TurtleBot3 Waffle. 5-phase curriculum, multi-scenario holdout, clipped value loss. Includes Colab n… |
...
| 更新 | 模型 | 下载 | Likes | 任务 |
|---|---|---:|---:|---|
| 2026-06-01 | [LiquidAI/LFM2.5-8B-A1B-MLX-8bit](https://huggingface.co/LiquidAI/LFM2.5-8B-A1B-MLX-8bit) | 3238 | 11 | text-generation |
| 2026-06-01 | [LiquidAI/LFM2.5-8B-A1B-MLX-4bit](https://huggingface.co/LiquidAI/LFM2.5-8B-A1B-MLX-4bit) | 1639 | 2 | text-generation |
| 2026-06-01 | [LiquidAI/LFM2.5-8B-A1B-MLX-bf16](https://huggingface.co/LiquidAI/LFM2.5-8B-A1B-MLX-bf16) | 853 | 2 | text-generation |
| 2026-06-01 | [LiquidAI/LFM2.5-8B-A1B-MLX-6bit](https://huggingface.co/LiquidAI/LFM2.5-8B-A1B-MLX-6bit) | 612 | 1 | text-generation |
| 2026-06-01 | [FlameF0X/LFM2.5-1.2B-Thinking-CodeX](https://huggingface.co/FlameF0X/LFM2.5-1.2B-Thinking-CodeX) | 421 | 1 | text-generation |
| 2026-06-01 | [Brunobkr/OFFELLIA_f16_LFM2.5-8B-A1B.gguf](https://huggingface.co/Brunobkr/OFFELLIA_f16_LFM2.5-8B-A1B.gguf) | 350 | 0 |  |
| 2026-06-01 | [LiquidAI/LFM2.5-8B-A1B-MLX-5bit](https://huggingface.co/LiquidAI/LFM2.5-8B-A1B-MLX-5bit) | 330 | 0 | text-generation |
| 2026-06-01 | [dealignai/LFM2.5-8B-A1B-MXFP8-CRACK](https://huggingface.co/dealignai/LFM2.5-8B-A1B-MXFP8-CRACK) | 207 | 1 | text-generation |
| 2026-06-01 | [dealignai/LFM2.5-8B-A1B-MXFP4-CRACK](https://huggingface.co/dealignai/LFM2.5-8B-A1B-MXFP4-CRACK) | 144 | 1 | text-generation |
| 2026-06-01 | [w-ahmad/LFM2.5-8B-A1B-GGUF-MoQ](https://huggingface.co/w-ahmad/LFM2.5-8B-A1B-GGUF-MoQ) | 72 | 0 |  |
| 2026-06-01 | [zaakirio/LFM2.5-1.2B-Instruct-Uncensored](https://huggingface.co/zaakirio/LFM2.5-1.2B-Instruct-Uncensored) | 0 | 1 | text-generation |
| 2026-06-01 | [zaakirio/LFM2.5-1.2B-Instruct-Uncensored-GGUF](https://huggingface.co/zaakirio/LFM2.5-1.2B-Instruct-Uncensored-GGUF) | 0 | 0 | text-generation |
