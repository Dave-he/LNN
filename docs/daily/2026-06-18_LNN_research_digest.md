...
| 更新 | 仓库 | Star | 语言 | 说明 |
|---|---|---:|---|---|
| 2026-06-17 | [maximecb/bebelm](https://github.com/maximecb/bebelm) | 56 | Rust | CPU-only, pure-Rust implementation of LiquidAI's LFM2.5-8B-A1B LLM |
...
| 2026-06-17 | [heimdilon/sncp-ppo-crowdnav](https://github.com/heimdilon/sncp-ppo-crowdnav) | 0 | Python | PPO + LTC (Liquid Time Constant) crowd-aware navigation for TurtleBot3 Waffle. 5-phase curriculum, multi-scenario holdout, clipped value loss. Includes Colab n… |
...
| 更新 | 模型 | 下载 | Likes | 任务 |
|---|---|---:|---:|---|
| 2026-06-17 | [NobodyWho/LFM2.5-1.2B-Instruct-GGUF](https://huggingface.co/NobodyWho/LFM2.5-1.2B-Instruct-GGUF) | 463 | 1 |  |
| 2026-06-17 | [NobodyWho/LFM2.5-VL-1.6B-GGUF](https://huggingface.co/NobodyWho/LFM2.5-VL-1.6B-GGUF) | 409 | 0 | image-text-to-text |
| 2026-06-17 | [NobodyWho/LFM2.5-VL-450M-GGUF](https://huggingface.co/NobodyWho/LFM2.5-VL-450M-GGUF) | 369 | 0 | image-text-to-text |
| 2026-06-17 | [NobodyWho/LFM2.5-8B-A1B-GGUF](https://huggingface.co/NobodyWho/LFM2.5-8B-A1B-GGUF) | 75 | 0 | text-generation |
...
| 2026-06-17 | [AtomicChat/lfm25-8b-a1b-GGUF](https://huggingface.co/AtomicChat/lfm25-8b-a1b-GGUF) | 0 | 0 | text-generation |
| 2026-06-17 | [famseamus/LFM2.5-DCR-8B-A1B-GGUF](https://huggingface.co/famseamus/LFM2.5-DCR-8B-A1B-GGUF) | 0 | 0 | text-generation |
| 2026-06-17 | [famseamus/LFM2.5-DCR-8B-A1B](https://huggingface.co/famseamus/LFM2.5-DCR-8B-A1B) | 0 | 0 | text-generation |
| 2026-06-16 | [LiquidAI/LFM2.5-1.2B-Instruct](https://huggingface.co/LiquidAI/LFM2.5-1.2B-Instruct) | 117234 | 610 | text-generation |
| 2026-06-16 | [LiquidAI/LFM2-ColBERT-350M](https://huggingface.co/LiquidAI/LFM2-ColBERT-350M) | 50213 | 140 | sentence-similarity |
| 2026-06-16 | [mkurman/LiquidAI-LFM2.5-350M-SYNTH](https://huggingface.co/mkurman/LiquidAI-LFM2.5-350M-SYNTH) | 69 | 1 | text-generation |
