...
| 2026-07-22 | [smparc/murmur](https://github.com/smparc/murmur) | 1 | Python | An enterprise-grade predictive maintenance engine that turns ambient mechanical noise into actionable text telemetry. Deployed on Kubernetes, Murmur leverages… |
| 2026-07-22 | [Moetasem/LTC-Model-with-Transfer-Learning](https://github.com/Moetasem/LTC-Model-with-Transfer-Learning) | 0 | Jupyter Notebook | Adaptive Liquid Time-Constant Equivalent Dynamic Model with Transfer Learning for Active Distribution Networks with Grid-Forming IBRs |
...
| 2026-07-21 | [AlexanderRumyantcev/LNN-LowLight](https://github.com/AlexanderRumyantcev/LNN-LowLight) | 0 | Python | Liquid Neural Networks (CfC) for low-light video enhancement on top of a RetinexFormer pipeline. |
...
| 更新 | 模型 | 下载 | Likes | 任务 |
|---|---|---:|---:|---|
| 2026-07-22 | [LiquidAI/LFM2.5-VL-1.6B-GGUF](https://huggingface.co/LiquidAI/LFM2.5-VL-1.6B-GGUF) | 69726 | 97 | image-text-to-text |
| 2026-07-22 | [reaperdoesntknow/LFM2.5-8B-A1B-Opus-Distil](https://huggingface.co/reaperdoesntknow/LFM2.5-8B-A1B-Opus-Distil) | 2771 | 6 | text-generation |
| 2026-07-22 | [reaperdoesntknow/LFM2.5-1.2B-Distilled-SFT](https://huggingface.co/reaperdoesntknow/LFM2.5-1.2B-Distilled-SFT) | 2757 | 0 | text-generation |
| 2026-07-22 | [AtomicChat/lfm25-8b-a1b-GGUF](https://huggingface.co/AtomicChat/lfm25-8b-a1b-GGUF) | 366 | 3 | text-generation |
| 2026-07-22 | [mradermacher/LFM2.5-1.2B-Instruction-following-i1-GGUF](https://huggingface.co/mradermacher/LFM2.5-1.2B-Instruction-following-i1-GGUF) | 0 | 0 |  |
| 2026-07-22 | [lewisdog/lfm2.5-1.2b-instruct-GGUF](https://huggingface.co/lewisdog/lfm2.5-1.2b-instruct-GGUF) | 0 | 0 |  |
| 2026-07-22 | [mradermacher/LFM2.5-1.2B-Instruction-following-GGUF](https://huggingface.co/mradermacher/LFM2.5-1.2B-Instruction-following-GGUF) | 0 | 0 |  |
| 2026-07-22 | [simaai/LFM2.5-1.2B-Thinking-a16w4_return_logits](https://huggingface.co/simaai/LFM2.5-1.2B-Thinking-a16w4_return_logits) | 0 | 0 | text-generation |
| 2026-07-22 | [simaai/LFM2.5-1.2B-Instruct-a16w4_return_logits](https://huggingface.co/simaai/LFM2.5-1.2B-Instruct-a16w4_return_logits) | 0 | 0 | text-generation |
| 2026-07-17 | [Synaptics/LiquidAI-LFM2.5-230M](https://huggingface.co/Synaptics/LiquidAI-LFM2.5-230M) | 1491 | 0 | text-generation |
| 2026-07-17 | [Synaptics/LiquidAI-LFM2-VL-450M](https://huggingface.co/Synaptics/LiquidAI-LFM2-VL-450M) | 140 | 0 | image-text-to-text |
| 2026-07-10 | [LiquidAI/LFM2.5-VL-450M-GGUF](https://huggingface.co/LiquidAI/LFM2.5-VL-450M-GGUF) | 8068 | 57 | image-text-to-text |
