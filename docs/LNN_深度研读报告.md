...
- **2026-06-08**：[[docs/daily/2026-06-08_LNN_research_digest.md|每日追踪]]，候选论文 25 篇，仓库 41 个，模型 18 个。
- **2026-06-09**：[[docs/daily/2026-06-09_LNN_research_digest.md|每日追踪]]，候选论文 25 篇，仓库 41 个，模型 18 个。**本轮研读**：select_papers_for_report.py 候选为空（n_total_arxiv=12, n_skipped_reported=12）—— digest 表格内 12 篇 arxiv 全部已研读，无新增候选；本轮跳过研读报告生成。
