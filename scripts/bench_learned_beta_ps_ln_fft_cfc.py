"""Round 186 — bench for LearnedBetaPS+LN+FFT-CfC (PRD #10-148).

18 cells: 3 conds × 3 datasets × 2 seeds × 30 epochs:
- lbps_lnfft_h3_75: Kx=5, Kh=3, β=0.75, FFT input features
- lbps_lnfft_h2_75: Kx=5, Kh=2
- lbps_lnfft_h5_75: Kx=5, Kh=5
...
CONDS = {
    "lbps_lnfft_h3_75": make_lbps_lnfft_h3_75,
    "lbps_lnfft_h2_75": make_lbps_lnfft_h2_75,
    "lbps_lnfft_h5_75": make_lbps_lnfft_h5_75,
}
...
def main():
    ...
    parser.add_argument("--out", type=str, default="results/bench_learned_beta_ps_ln_fft_cfc.json")
    ...
    print(f"=== Round 186 LearnedBetaPS+LN+FFT-CfC Bench ===")
