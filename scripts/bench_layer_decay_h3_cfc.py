"""Round 168 — bench for LayerDecay-H3-CfC (Kh=3 with REVERSE β) (PRD #10-130).

42 cells: 7 conds × 3 datasets × 2 seeds × 30 epochs:
- ld_reverse_h3_k5:    3-layer, Kx=5, Kh=3, REVERSE β ∈ [0.99, 0.75, 0.5]
- ld_reverse_h4_k5:    3-layer, Kx=5, Kh=4, REVERSE β ∈ [0.99, 0.83, 0.66, 0.5]
- ld_reverse_h3_wider: 3-layer, Kx=5, Kh=3, REVERSE β ∈ [0.999, 0.7, 0.3]
- ld_reverse_h3_k6:    3-layer, Kx=6, Kh=3, REVERSE β ∈ [0.99, 0.75, 0.5]
- ld_reverse_h3_h2:    3-layer, Kx=5, Kh=3, REVERSE β ∈ [0.95, 0.85, 0.7]
- ld_constant_h3:      3-layer, Kx=5, Kh=3, constant β ∈ {0.7, 0.85, 0.95} (control)
...
# ---------------------------------------------------------------------------
# Data generators (mirror round 165/167)
# ---------------------------------------------------------------------------
...
CONDS = {
    "ld_reverse_h3_k5": make_ld_reverse_h3_k5,
    "ld_reverse_h4_k5": make_ld_reverse_h4_k5,
    "ld_reverse_h3_wider": make_ld_reverse_h3_wider,
    "ld_reverse_h3_k6": make_ld_reverse_h3_k6,
    "ld_reverse_h3_h2": make_ld_reverse_h3_h2,
    "ld_constant_h3": make_ld_constant_h3,
}
...
def main():
    ...
    parser.add_argument("--out", type=str, default="results/bench_layer_decay_h3_cfc.json")
    ...
    print(f"=== Round 168 LayerDecay-H3-CfC Bench ===")
    ...
    print(f"Kh=3/4 with REVERSE β schedule, building on round 167")
