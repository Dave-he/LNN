"""Round 223 — bench for PerLayerScaleCfC (PRD #10-185, 2026-06-16)."""
...
def main():
    conds = ["cf", "4spectralbiasdrop", "perlayer_234"]
    seeds = [0, 1]
    rows = []
    ...
    out = {
        "round": 223, "date": "2026-06-16",
        "config": "lbps_lnkhlfft_perlayer_234_5_3_2 (per-layer 2,3,4) vs r216 (uniform 4) vs baseline",
        "epochs": 30, "seeds": seeds, "n_cells": len(rows), "rows": rows,
    }
    out_path = "results/bench_learned_beta_ps_ln_khlfft_perlayer_scale_cfc.json"
