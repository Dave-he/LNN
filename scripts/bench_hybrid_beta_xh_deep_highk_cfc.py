"""Round 165 — bench for HybridBeta-XH-Deep-HighK-CfC (3-layer + high K) (PRD #10-127).

24 cells: 4 conds × 3 datasets × 2 seeds, 30 epochs:
- hb_xh_deep_h1_k4: 3-layer, Kx=4, Kh=1, scalar β=0.9 on h
- hb_xh_deep_h1_k5: 3-layer, Kx=5, Kh=1, scalar β=0.9 on h
- hb_xh_deep_h2_k4: 3-layer, Kx=4, Kh=2, scalar β ∈ {0.7, 0.95} on h
- hb_xh_deep_h2_k5: 3-layer, Kx=5, Kh=2, scalar β ∈ {0.7, 0.95} on h
...
CONDS = {
    "hb_xh_deep_h1_k4": make_hb_xh_deep_h1_k4,
    "hb_xh_deep_h1_k5": make_hb_xh_deep_h1_k5,
    "hb_xh_deep_h2_k4": make_hb_xh_deep_h2_k4,
    "hb_xh_deep_h2_k5": make_hb_xh_deep_h2_k5,
}
...
def main():
    ...
    parser.add_argument("--out", type=str, default="results/bench_hybrid_beta_xh_deep_highk_cfc.json")
    ...
    print(f"=== Round 165 HybridBeta-XH-Deep-HighK-CfC Bench ===")
    print(f"epochs={args.epochs}, seeds={args.seeds}, B={args.batch}, T={args.T}, H={H}, lr={args.lr}")
    print(f"3-layer + high K (Kx=4 or 5) variants of round 164 hybrid β")
