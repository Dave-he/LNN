"""Round 180 — bench for LearnedBetaPS+LN+Khl-CfC (PRD #10-142).

36 cells: 6 conds × 3 datasets × 2 seeds × 30 epochs:
- lbps_ln_khl_2_2_2: Kh=[2,2,2] (round 179 control)
- lbps_ln_khl_2_3_5: Kh=[2,3,5] (round 173 ladder + LN)
- lbps_ln_khl_2_3_3: Kh=[2,3,3] (mild ladder)
- lbps_ln_khl_3_3_3: Kh=[3,3,3] (Kh=3 + LN)
- lbps_ln_khl_5_3_2: Kh=[5,3,2] (high-to-low)
- lbps_ln_khl_2_5_2: Kh=[2,5,2] (low-high-low)
...
CONDS = {
    "lbps_ln_khl_2_2_2": make_lbps_ln_khl_2_2_2,
    "lbps_ln_khl_2_3_5": make_lbps_ln_khl_2_3_5,
    "lbps_ln_khl_2_3_3": make_lbps_ln_khl_2_3_3,
    "lbps_ln_khl_3_3_3": make_lbps_ln_khl_3_3_3,
    "lbps_ln_khl_5_3_2": make_lbps_ln_khl_5_3_2,
    "lbps_ln_khl_2_5_2": make_lbps_ln_khl_2_5_2,
}
...
def main():
    ...
    parser.add_argument("--out", type=str, default="results/bench_learned_beta_ps_ln_khl_cfc.json")
    ...
    print(f"=== Round 180 LearnedBetaPS+LN+Khl-CfC Bench ===")
