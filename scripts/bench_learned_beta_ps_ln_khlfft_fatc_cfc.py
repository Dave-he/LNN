"""Round 225 — bench for FATCSpectralCfC (PRD #10-187, 2026-06-17)."""
...
def main():
    conds = ["cf", "4spectralbiasdrop", "adaptive_scale", "fatc"]
    seeds = [0, 1]
    rows = []
    ...
    out = {
        "round": 225, "date": "2026-06-17",
        "config": "lbps_lnkhlfft_fatc_5_3_2 (freq-adaptive time constants) vs r216 (4-scale) vs r224 (adaptive_scale) vs cf",
        "epochs": 30, "seeds": seeds, "n_cells": len(rows), "rows": rows,
    }
    out_path = "results/bench_learned_beta_ps_ln_khlfft_fatc_cfc.json"
