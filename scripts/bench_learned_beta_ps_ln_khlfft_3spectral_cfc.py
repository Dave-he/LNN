"""Round 210 — bench for 3ScaleSpectralCfC (PRD #10-172, 2026-06-16)."""
...
def main():
    ...
    out = {
        "round": 210, "date": "2026-06-16",
        "config": "lbps_lnkhlfft_3spectral_5_3_2 (3-scale FFT) vs baseline",
        "epochs": 30, "seeds": seeds, "n_cells": len(rows), "rows": rows,
    }
    out_path = "results/bench_learned_beta_ps_ln_khlfft_3spectral_cfc.json"
