"""Round 179 — bench for LearnedBetaPS+LN-CfC (PRD #10-141).

18 cells: 3 conds × 3 datasets × 2 seeds × 30 epochs:
- lbps_ln_h3_75: Kx=5, Kh=3, β_init=0.75, LayerNorm (control)
- lbps_ln_h2_75: Kx=5, Kh=2, LayerNorm (sin-favoring)
- lbps_ln_h5_75: Kx=5, Kh=5, LayerNorm (structured-favoring)
...
CONDS = {
    "lbps_ln_h3_75": make_lbps_ln_h3_75,
    "lbps_ln_h2_75": make_lbps_ln_h2_75,
    "lbps_ln_h5_75": make_lbps_ln_h5_75,
}
...
def main():
    ...
    parser.add_argument("--out", type=str, default="results/bench_learned_beta_ps_ln_cfc.json")
    ...
    print(f"=== Round 179 LearnedBetaPS+LN-CfC Bench ===")
