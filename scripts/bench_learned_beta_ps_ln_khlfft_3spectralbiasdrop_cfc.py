"""Round 221 — bench for 3ScaleSpectralBiasDropCfC (PRD #10-183, 2026-06-16)."""
...
from lnn.core.learned_beta_ps_ln_khlfft_3spectralbiasdrop_cfc import make_lbps_lnkhlfft_3spectralbiasdrop_5_3_2
...
def run_one_cell(ds_name, cond, seed, hidden=16, epochs=30):
    ...
    elif cond == "3spectralbiasdrop":
        model = make_lbps_lnkhlfft_3spectralbiasdrop_5_3_2(D, hidden, 1)
    else:
...
def main():
    conds = ["cf", "4spectralbiasdrop", "3spectralbiasdrop"]
    seeds = [0, 1]
    rows = []
    ...
    out = {
        "round": 221, "date": "2026-06-16",
        "config": "lbps_lnkhlfft_3spectralbiasdrop_5_3_2 (3-scale) vs r216 (4-scale) vs baseline",
        "epochs": 30, "seeds": seeds, "n_cells": len(rows), "rows": rows,
    }
    out_path = "results/bench_learned_beta_ps_ln_khlfft_3spectralbiasdrop_cfc.json"
