"""Round 219 — bench for 4ScaleSpectralBiasDropAdaptiveCfC (PRD #10-181, 2026-06-16)."""
...
from lnn.core.learned_beta_ps_ln_khlfft_4spectralbiasdrop_adaptive_cfc import make_lbps_lnkhlfft_4spectralbiasdrop_adaptive_5_3_2
...
def run_one_cell(ds_name, cond, seed, hidden=16, epochs=30):
    ...
    elif cond == "4spectralbiasdrop_adaptive":
        model = make_lbps_lnkhlfft_4spectralbiasdrop_adaptive_5_3_2(D, hidden, 1)
    else:
...
def main():
    conds = ["cf", "4spectralbiasdrop", "4spectralbiasdrop_adaptive"]
    seeds = [0, 1]
    rows = []
    ...
    out = {
        "round": 219, "date": "2026-06-16",
        "config": "lbps_lnkhlfft_4spectralbiasdrop_adaptive_5_3_2 (adaptive weights) vs r216 (avg) vs baseline",
        "epochs": 30, "seeds": seeds, "n_cells": len(rows), "rows": rows,
    }
    out_path = "results/bench_learned_beta_ps_ln_khlfft_4spectralbiasdrop_adaptive_cfc.json"
