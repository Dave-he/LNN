"""Round 196 — bench for DropConnect on cell weights (PRD #10-158)."""
...
from lnn.core.learned_beta_ps_ln_khlfft_dropconnect_cfc import make_lbps_lnkhlfft_dropconnect_5_3_2
...
def run_dataset(name, make_fn, n_seeds=2, n_epochs=30, hidden=12):
    ...
    conds = [
        ...
        ("lbps_lnkhlfft_dropconnect_05", lambda: make_lbps_lnkhlfft_dropconnect_5_3_2(2, hidden, 1, dropconnect_p=0.05)),
        ("lbps_lnkhlfft_dropconnect_10", lambda: make_lbps_lnkhlfft_dropconnect_5_3_2(2, hidden, 1, dropconnect_p=0.10)),
        ("lbps_lnkhlfft_dropconnect_20", lambda: make_lbps_lnkhlfft_dropconnect_5_3_2(2, hidden, 1, dropconnect_p=0.20)),
    ]
...
def main():
    ...
    out_path = os.path.join(os.path.dirname(__file__), "..", "results", "bench_learned_beta_ps_ln_khlfft_dropconnect_cfc.json")
    ...
    for ds, rows in out["datasets"].items():
        print(f"\n{ds}:")
        for cname in ["lbps_lnkhlfft_5_3_2_mse", "lbps_lnkhlfft_dropconnect_05", "lbps_lnkhlfft_dropconnect_10", "lbps_lnkhlfft_dropconnect_20"]:
