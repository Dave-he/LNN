"""Round 215 — bench for 4ScaleSpectralBiasCfC (PRD #10-177, 2026-06-16)."""
...
def main():
    conds = ["cf", "4spectral", "4spectralbias"]
    seeds = [0, 1]
    rows = []
    ...
    out = {
        "round": 215, "date": "2026-06-16",
        "config": "lbps_lnkhlfft_4spectralbias_5_3_2 vs 4spectral vs baseline",
        "epochs": 30, "seeds": seeds, "n_cells": len(rows), "rows": rows,
    }
    out_path = "results/bench_learned_beta_ps_ln_khlfft_4spectralbias_cfc.json"
