"""Round 187 — bench for LearnedBetaPS+LN+Khl+FFT-CfC (PRD #10-149).

12 cells: 2 conds × 3 datasets × 2 seeds × 30 epochs:
- lbps_lnkhlfft_2_5_2: Kx=5, Kh=[2,5,2], FFT input features
- lbps_lnkhlfft_5_3_2: Kx=5, Kh=[5,3,2], FFT input features
...
CONDS = {
    "lbps_lnkhlfft_2_5_2": make_lbps_lnkhlfft_2_5_2,
    "lbps_lnkhlfft_5_3_2": make_lbps_lnkhlfft_5_3_2,
}
...
def main():
    ...
    parser.add_argument("--out", type=str, default="results/bench_learned_beta_ps_ln_khlfft_cfc.json")
    ...
    print(f"=== Round 187 LearnedBetaPS+LN+Khl+FFT-CfC Bench ===")
