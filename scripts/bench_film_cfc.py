"""Round 153 — bench for FiLM-CfC (Feature-wise Linear Modulation) (PRD #10-115).
...
from lnn.core.film_cfc import FiLMCfCStackedNetwork


# ---------------------------------------------------------------------------
# Data generators (mirror scripts/bench_tdsa_cfc.py)
# ---------------------------------------------------------------------------
...
def make_film_global(input_size, hidden_size, output_size, num_layers=2):
    return FiLMCfCStackedNetwork(
        input_size=input_size,
        hidden_size=hidden_size,
        output_size=output_size,
        num_layers=num_layers,
...
def make_film_self(input_size, hidden_size, output_size, num_layers=2):
    return FiLMCfCStackedNetwork(
        input_size=input_size,
        hidden_size=hidden_size,
        output_size=output_size,
...
def make_film_concat(input_size, hidden_size, output_size, num_layers=2):
    return FiLMCfCStackedNetwork(
        input_size=input_size,
        hidden_size=hidden_size,
        output_size=output_size,
...
CONDS = {
    "cfc": make_cfc,
    "film_global": make_film_global,
    "film_self": make_film_self,
    "film_concat": make_film_concat,
}
...
def main():
    ...
    parser.add_argument("--out", type=str, default="results/bench_film_cfc.json")
    ...
    print(f"=== Round 153 FiLM-CfC Bench ===")
