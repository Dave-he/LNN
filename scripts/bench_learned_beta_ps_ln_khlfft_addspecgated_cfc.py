"""Round 201 — AdditiveSpectralGated-CfC bench (PRD #10-163, 2026-06-16)."""
...
from lnn.core.learned_beta_ps_ln_khlfft_addspecgated_cfc import make_lbps_lnkhlfft_addspecgated_5_3_2
...
def run_one_cell(ds_name, cond, seed, hidden=12, epochs=30):
    ...
    if cond == "cf":
        ...
        model = make_lbps_lnkhlfft_addspecgated_5_3_2(
            input_size=2, hidden_size=hidden, output_size=1,
        )
    else:
...
def main():
    ...
    out = {
        "round": 201,
        "date": "2026-06-16",
        "config": "lbps_lnkhlfft_addspecgated_5_3_2 vs lbps_lnkhlfft_specgated_5_3_2 vs lbps_lnkhlfft_5_3_2",
        "epochs": 30,
        "seeds": [0, 1],
        "n_cells": len(rows),
        "rows": rows,
    }
    out_path = "results/bench_learned_beta_ps_ln_khlfft_addspecgated_cfc.json"
