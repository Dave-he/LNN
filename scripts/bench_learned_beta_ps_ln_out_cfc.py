"""Round 183 — bench for LearnedBetaPS+LNout-CfC (PRD #10-145).

18 cells: 3 conds × 3 datasets × 2 seeds × 30 epochs:
- lbps_lno_h3_75: Kx=5, Kh=3, β=0.75, Output LN
- lbps_lno_h2_75: Kx=5, Kh=2, Output LN
- lbps_lno_h5_75: Kx=5, Kh=5, Output LN
...
CONDS = {
    "lbps_lno_h3_75": make_lbps_lno_h3_75,
    "lbps_lno_h2_75": make_lbps_lno_h2_75,
    "lbps_lno_h5_75": make_lbps_lno_h5_75,
}
...
def main():
    ...
    parser.add_argument("--out", type=str, default="results/bench_learned_beta_ps_ln_out_cfc.json")
    ...
    print(f"=== Round 183 LearnedBetaPS+LNout-CfC Bench ===")
