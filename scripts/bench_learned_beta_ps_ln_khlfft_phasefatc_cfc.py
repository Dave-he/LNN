"""Round 226 — bench for PhaseFATCSpectralCfC (PRD #10-188, 2026-06-17)."""
...
def main():
    conds = ["cf", "4spectralbiasdrop", "fatc", "phasefatc"]
    seeds = [0, 1]
    rows = []
    ...
    out = {
        "round": 226, "date": "2026-06-17",
        "config": "lbps_lnkhlfft_phasefatc_5_3_2 (phase-aware FATC, mag+cos+sin) vs r225 (FATC, mag only) vs r216 vs cf",
        "epochs": 30, "seeds": seeds, "n_cells": len(rows), "rows": rows,
    }
    out_path = "results/bench_learned_beta_ps_ln_khlfft_phasefatc_cfc.json"
