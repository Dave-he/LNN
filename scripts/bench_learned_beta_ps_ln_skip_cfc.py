"""Round 184 — bench for LearnedBetaPS+LN+Skip-CfC (PRD #10-146).

18 cells: 3 conds × 3 datasets × 2 seeds × 30 epochs:
- lbps_lns_h3_75: Kx=5, Kh=3, β=0.75, residual_init=0.1
- lbps_lns_h2_75: Kx=5, Kh=2, residual_init=0.1
- lbps_lns_h5_75: Kx=5, Kh=5, residual_init=0.1
...
CONDS = {
    "lbps_lns_h3_75": make_lbps_lns_h3_75,
    "lbps_lns_h2_75": make_lbps_lns_h2_75,
    "lbps_lns_h5_75": make_lbps_lns_h5_75,
}
...
def main():
    ...
    parser.add_argument("--out", type=str, default="results/bench_learned_beta_ps_ln_skip_cfc.json")
    ...
    print(f"=== Round 184 LearnedBetaPS+LN+Skip-CfC Bench ===")
