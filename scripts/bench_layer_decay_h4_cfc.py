"""Round 169 — bench for LayerDecay-H4-CfC (Kh=4 with constant β) (PRD #10-131).

42 cells: 7 conds × 3 datasets × 2 seeds × 30 epochs:
- ld_constant_h4_default: 3-layer, Kx=5, Kh=4, β ∈ {0.6, 0.75, 0.85, 0.95}
- ld_constant_h4_wide:    3-layer, Kx=5, Kh=4, β ∈ {0.5, 0.7, 0.85, 0.99}
- ld_constant_h4_narrow:  3-layer, Kx=5, Kh=4, β ∈ {0.8, 0.85, 0.9, 0.95}
- ld_constant_h3_k6:      3-layer, Kx=6, Kh=3, β ∈ {0.7, 0.85, 0.95}
- ld_constant_h3_wider:   3-layer, Kx=5, Kh=3, β ∈ {0.6, 0.8, 0.99}
- ld_constant_h3_finer:   3-layer, Kx=5, Kh=3, β ∈ {0.75, 0.85, 0.95}
- ld_constant_h5:         3-layer, Kx=5, Kh=5, β ∈ {0.5, 0.7, 0.85, 0.95, 0.99}
...
# ---------------------------------------------------------------------------
# Data generators (mirror round 165/167/168)
# ---------------------------------------------------------------------------
...
CONDS = {
    "ld_constant_h4_default": make_ld_constant_h4_default,
    "ld_constant_h4_wide": make_ld_constant_h4_wide,
    "ld_constant_h4_narrow": make_ld_constant_h4_narrow,
    "ld_constant_h3_k6": make_ld_constant_h3_k6,
    "ld_constant_h3_wider": make_ld_constant_h3_wider,
    "ld_constant_h3_finer": make_ld_constant_h3_finer,
    "ld_constant_h5": make_ld_constant_h5,
}
...
def main():
    ...
    parser.add_argument("--out", type=str, default="results/bench_layer_decay_h4_cfc.json")
    ...
    print(f"=== Round 169 LayerDecay-H4-CfC Bench ===")
    ...
    print(f"Kh=4/5 with constant β, building on round 168 (Kh=3)")
