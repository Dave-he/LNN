"""Round 218 — bench for 4ScaleSpectralBiasDrop3CfC (PRD #10-180, 2026-06-16)."""
...
from lnn.core.learned_beta_ps_ln_khlfft_4spectralbiasdrop3_cfc import make_lbps_lnkhlfft_4spectralbiasdrop3_5_3_2
...
def run_one_cell(ds_name, cond, seed, hidden=16, epochs=30):
    ...
    elif cond == "4spectralbiasdrop3":
        model = make_lbps_lnkhlfft_4spectralbiasdrop3_5_3_2(D, hidden, 1)
    else:
...
def main():
    conds = ["cf", "4spectralbiasdrop", "4spectralbiasdrop3"]
    seeds = [0, 1]
    rows = []
    ...
    out = {
        "round": 218, "date": "2026-06-16",
        "config": "lbps_lnkhlfft_4spectralbiasdrop3_5_3_2 (dropout=0.3) vs r216 (=0.2) vs baseline",
        "epochs": 30, "seeds": seeds, "n_cells": len(rows), "rows": rows,
    }
    out_path = "results/bench_learned_beta_ps_ln_khlfft_4spectralbiasdrop3_cfc.json"
