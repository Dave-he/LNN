"""Round 208 — bench for StableSSMCfC (PRD #10-170, 2026-06-16)."""
...
from lnn.core.learned_beta_ps_ln_khlfft_stablessm_cfc import make_lbps_lnkhlfft_stablessm_5_3_2
...
def run_one_cell(ds_name, cond, seed, hidden=12, epochs=30):
    ...
    if cond == "cf":
        ...
        model = make_lbps_lnkhlfft_stablessm_5_3_2(D, hidden, 1)
    else:
...
def main():
    ...
    out = {
        "round": 208, "date": "2026-06-16",
        "config": "lbps_lnkhlfft_stablessm_5_3_2 (sigmoid-A SSM) vs baseline",
        "epochs": 30, "seeds": seeds, "n_cells": len(rows), "rows": rows,
    }
    out_path = "results/bench_learned_beta_ps_ln_khlfft_stablessm_cfc.json"
