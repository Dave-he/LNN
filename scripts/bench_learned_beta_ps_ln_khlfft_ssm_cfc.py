"""Round 207 — bench for SSMCfC (PRD #10-169, 2026-06-16)."""
...
from lnn.core.learned_beta_ps_ln_khlfft_ssm_cfc import make_lbps_lnkhlfft_ssm_5_3_2
...
def run_one_cell(ds_name, cond, seed, hidden=12, epochs=30):
    ...
    if cond == "cf":
        ...
        model = make_lbps_lnkhlfft_ssm_5_3_2(D, hidden, 1)
    else:
...
def main():
    ...
    out = {
        "round": 207, "date": "2026-06-16",
        "config": "lbps_lnkhlfft_ssm_5_3_2 (diagonal SSM hybrid) vs baseline",
        "epochs": 30, "seeds": seeds, "n_cells": len(rows), "rows": rows,
    }
    out_path = "results/bench_learned_beta_ps_ln_khlfft_ssm_cfc.json"
