"""Round 213 — bench for 3ScaleSpectralDropCfC (PRD #10-175, 2026-06-16)."""
...
from lnn.core.learned_beta_ps_ln_khlfft_3spectral_cfc import make_lbps_lnkhlfft_3spectral_5_3_2
from lnn.core.learned_beta_ps_ln_khlfft_3spectraldrop_cfc import make_lbps_lnkhlfft_3spectraldrop_5_3_2
...
def run_one_cell(ds_name, cond, seed, hidden=16, epochs=30):
    ...
    if cond == "cf":
        ...
        model = make_lbps_lnkhlfft_3spectral_5_3_2(D, hidden, 1)
    elif cond == "3spectraldrop":
        model = make_lbps_lnkhlfft_3spectraldrop_5_3_2(D, hidden, 1, dropout_p=0.2)
    else:
...
def main():
    conds = ["cf", "3spectral", "3spectraldrop"]
    seeds = [0, 1]
    rows = []
    ...
    out = {
        "round": 213, "date": "2026-06-16",
        "config": "lbps_lnkhlfft_3spectraldrop_5_3_2 (dropout p=0.2) vs 3spectral vs baseline",
        "epochs": 30, "seeds": seeds, "n_cells": len(rows), "rows": rows,
    }
    out_path = "results/bench_learned_beta_ps_ln_khlfft_3spectraldrop_cfc.json"
