"""Round 188 — bench for LearnedBetaPS+LN+Khl+FFT2-CfC (PRD #10-150).

12 cells: 2 conds × 3 datasets × 2 seeds × 30 epochs:
- lbps_lnkhlfft2_2_5_2: Kx=5, Kh=[2,5,2], FFT2 (mag+phase) input features
- lbps_lnkhlfft2_5_3_2: Kx=5, Kh=[5,3,2], FFT2 (mag+phase) input features
...
CONDS = {
    "lbps_lnkhlfft2_2_5_2": make_lbps_lnkhlfft2_2_5_2,
    "lbps_lnkhlfft2_5_3_2": make_lbps_lnkhlfft2_5_3_2,
}
...
def main():
    ...
    parser.add_argument("--out", type=str, default="results/bench_learned_beta_ps_ln_khlfft2_cfc.json")
    ...
    print(f"=== Round 188 LearnedBetaPS+LN+Khl+FFT2-CfC Bench ===")
