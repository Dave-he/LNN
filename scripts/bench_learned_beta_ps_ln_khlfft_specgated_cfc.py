"""Round 200 — SpectralGated-CfC bench (PRD #10-162, 2026-06-16)."""
...
def main():
    ...
    out = {
        "round": 200,
        "date": "2026-06-16",
        "config": "lbps_lnkhlfft_specgated_5_3_2 vs lbps_lnkhlfft_5_3_2",
        "epochs": 30,
        "seeds": [0, 1],
        "n_cells": len(rows),
        "rows": rows,
    }
    out_path = "results/bench_learned_beta_ps_ln_khlfft_specgated_cfc.json"
