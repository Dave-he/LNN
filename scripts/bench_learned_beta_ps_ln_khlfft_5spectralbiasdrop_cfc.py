"""Round 217 — bench for 5ScaleSpectralBiasDropCfC (PRD #10-179, 2026-06-16)."""
...
from lnn.core.learned_beta_ps_ln_khlfft_5spectralbiasdrop_cfc import make_lbps_lnkhlfft_5spectralbiasdrop_5_3_2
...
def run_one_cell(ds_name, cond, seed, hidden=16, epochs=30):
    ...
    elif cond == "5spectralbiasdrop":
        model = make_lbps_lnkhlfft_5spectralbiasdrop_5_3_2(D, hidden, 1)
    else:
...
def main():
    conds = ["cf", "4spectralbiasdrop", "5spectralbiasdrop"]
    seeds = [0, 1]
    rows = []
    ...
    out = {
        "round": 217, "date": "2026-06-16",
        "config": "lbps_lnkhlfft_5spectralbiasdrop_5_3_2 vs 4spectralbiasdrop vs baseline",
        "epochs": 30, "seeds": seeds, "n_cells": len(rows), "rows": rows,
    }
    out_path = "results/bench_learned_beta_ps_ln_khlfft_5spectralbiasdrop_cfc.json"
