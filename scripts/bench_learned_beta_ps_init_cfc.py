"""Round 174 — bench for LearnedPerScaleBeta+PerLayerInit-CfC (PRD #10-136).

42 cells: 7 conds × 3 datasets × 2 seeds × 30 epochs:
- lbps_init_uniform: β_init=0.75 (round 171 control)
- lbps_init_low_to_high: β_init=[0.5, 0.75, 0.95] (Kh=3)
- lbps_init_high_to_low: β_init=[0.95, 0.75, 0.5] (Kh=3)
- lbps_init_wide: β_init=[0.5, 0.85, 0.99] (Kh=3)
- lbps_init_narrow: β_init=[0.7, 0.75, 0.8] (Kh=3)
- lbps_init_kh2_low_to_high: Kh=2, β_init=[0.5, 0.75, 0.95]
- lbps_init_kh2_high_to_low: Kh=2, β_init=[0.95, 0.75, 0.5]
...
# ---------------------------------------------------------------------------
# Data generators (mirror round 165-173)
# ---------------------------------------------------------------------------
...
CONDS = {
    "lbps_init_uniform": make_lbps_init_uniform,
    "lbps_init_low_to_high": make_lbps_init_low_to_high,
    "lbps_init_high_to_low": make_lbps_init_high_to_low,
    "lbps_init_wide": make_lbps_init_wide,
    "lbps_init_narrow": make_lbps_init_narrow,
    "lbps_init_kh2_low_to_high": make_lbps_init_kh2_low_to_high,
    "lbps_init_kh2_high_to_low": make_lbps_init_kh2_high_to_low,
}
...
def main():
    ...
    parser.add_argument("--out", type=str, default="results/bench_learned_beta_ps_init_cfc.json")
    ...
    print(f"=== Round 174 LearnedBetaPS+PerLayerInit-CfC Bench ===")
