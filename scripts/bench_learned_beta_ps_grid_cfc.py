"""Round 177 — bench for LearnedBetaPS+KxKhGrid-CfC (PRD #10-139).

54 cells: 9 conds × 3 datasets × 2 seeds × 30 epochs.
- lbps_grid_3_2: Kx=3, Kh=2 (small-small, sin-favoring)
- lbps_grid_3_3: Kx=3, Kh=3
- lbps_grid_3_5: Kx=3, Kh=5
- lbps_grid_5_2: Kx=5, Kh=2
- lbps_grid_5_3: Kx=5, Kh=3 (control, round 171)
- lbps_grid_5_5: Kx=5, Kh=5
- lbps_grid_7_2: Kx=7, Kh=2
- lbps_grid_7_3: Kx=7, Kh=3
- lbps_grid_7_5: Kx=7, Kh=5 (large-large, structured-favoring)
...
# ---------------------------------------------------------------------------
# Data generators (mirror round 165-176)
# ---------------------------------------------------------------------------
...
CONDS = {
    "lbps_grid_3_2": make_lbps_grid_3_2,
    "lbps_grid_3_3": make_lbps_grid_3_3,
    "lbps_grid_3_5": make_lbps_grid_3_5,
    "lbps_grid_5_2": make_lbps_grid_5_2,
    "lbps_grid_5_3": make_lbps_grid_5_3,
    "lbps_grid_5_5": make_lbps_grid_5_5,
    "lbps_grid_7_2": make_lbps_grid_7_2,
    "lbps_grid_7_3": make_lbps_grid_7_3,
    "lbps_grid_7_5": make_lbps_grid_7_5,
}
...
def main():
    ...
    parser.add_argument("--out", type=str, default="results/bench_learned_beta_ps_grid_cfc.json")
    ...
    print(f"=== Round 177 LearnedBetaPS+KxKhGrid-CfC Bench ===")
    print(f"epochs={args.epochs}, seeds={args.seeds}, B={args.batch}, T={args.T}, H={H}, lr={args.lr}")
    print(f"9 conds × 3 datasets × 2 seeds × 30 epochs = 54 cells")
