"""Round 212 — bench for 4ScaleSpectralCfC (PRD #10-174, 2026-06-16)."""
...
def main():
    ...
    out = {
        "round": 212, "date": "2026-06-16",
        "config": "lbps_lnkhlfft_4spectral_5_3_2 vs 3spectral vs baseline",
        "epochs": 30, "seeds": seeds, "n_cells": len(rows), "rows": rows,
    }
    out_path = "results/bench_learned_beta_ps_ln_khlfft_4spectral_cfc.json"
