"""Round 222 — bench for 2ScaleSpectralBiasDropCfC (PRD #10-184, 2026-06-16)."""
...
from lnn.core.learned_beta_ps_ln_khlfft_2spectralbiasdrop_cfc import make_lbps_lnkhlfft_2spectralbiasdrop_5_3_2
...
def run_one_cell(ds_name, cond, seed, hidden=16, epochs=30):
    ...
    elif cond == "2spectralbiasdrop":
        model = make_lbps_lnkhlfft_2spectralbiasdrop_5_3_2(D, hidden, 1)
    else:
...
def main():
    conds = ["cf", "4spectralbiasdrop", "2spectralbiasdrop"]
    seeds = [0, 1]
    rows = []
    ...
    out = {
        "round": 222, "date": "2026-06-16",
        "config": "lbps_lnkhlfft_2spectralbiasdrop_5_3_2 (2-scale) vs r216 (4-scale) vs baseline",
        "epochs": 30, "seeds": seeds, "n_cells": len(rows), "rows": rows,
    }
    out_path = "results/bench_learned_beta_ps_ln_khlfft_2spectralbiasdrop_cfc.json"
