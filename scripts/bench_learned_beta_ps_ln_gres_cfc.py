"""Round 185 — bench for LearnedBetaPS+LN+GatedResidual-CfC (PRD #10-147).

18 cells: 3 conds × 3 datasets × 2 seeds × 30 epochs:
- lbps_lngr_h3_75: Kx=5, Kh=3, β=0.75, α=0.1, residual_init=0.1
- lbps_lngr_h2_75: Kx=5, Kh=2
- lbps_lngr_h5_75: Kx=5, Kh=5
...
CONDS = {
    "lbps_lngr_h3_75": make_lbps_lngr_h3_75,
    "lbps_lngr_h2_75": make_lbps_lngr_h2_75,
    "lbps_lngr_h5_75": make_lbps_lngr_h5_75,
}
...
def main():
    ...
    parser.add_argument("--out", type=str, default="results/bench_learned_beta_ps_ln_gres_cfc.json")
    ...
    print(f"=== Round 185 LearnedBetaPS+LN+GatedResidual-CfC Bench ===")
    print(f"epochs={args.epochs}, seeds={args.seeds}, B={args.batch}, T={args.T}, H={H}, lr={args.lr}")
    print(f"3 conds × 3 datasets × 2 seeds × 30 epochs = 18 cells")
