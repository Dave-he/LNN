"""Round 173 — bench for LearnedPerScaleBeta+KhLadder-CfC (PRD #10-135).

42 cells: 7 conds × 3 datasets × 2 seeds × 30 epochs:
- lbps_khl_3_3_3: Kh=[3,3,3] control (round 171)
- lbps_khl_2_2_2: Kh=[2,2,2] (round 171 sin winner control)
- lbps_khl_5_5_5: Kh=[5,5,5] (round 171 structured winner control)
- lbps_khl_5_3_2: Kh=[5,3,2] high-to-low
- lbps_khl_2_3_5: Kh=[2,3,5] low-to-high
- lbps_khl_3_2_2: Kh=[3,2,2] sin-favoring
- lbps_khl_5_5_2: Kh=[5,5,2] structured-favoring
...
# ---------------------------------------------------------------------------
# Data generators (mirror round 165-172)
# ---------------------------------------------------------------------------
...
CONDS = {
    "lbps_khl_3_3_3": make_lbps_khl_3_3_3,
    "lbps_khl_2_2_2": make_lbps_khl_2_2_2,
    "lbps_khl_5_5_5": make_lbps_khl_5_5_5,
    "lbps_khl_5_3_2": make_lbps_khl_5_3_2,
    "lbps_khl_2_3_5": make_lbps_khl_2_3_5,
    "lbps_khl_3_2_2": make_lbps_khl_3_2_2,
    "lbps_khl_5_5_2": make_lbps_khl_5_5_2,
}
...
def main():
    ...
    parser.add_argument("--out", type=str, default="results/bench_learned_beta_ps_khl_cfc.json")
    ...
    print(f"=== Round 173 LearnedBetaPS+KhLadder-CfC Bench ===")
