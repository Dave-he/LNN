"""Round 178 — bench for LearnedBetaPS+IC-CfC (PRD #10-140).

30 cells: 5 conds × 3 datasets × 2 seeds × 30 epochs:
- lbps_ic_h3_75: Kx=5, Kh=3, β_init=0.75 (control)
- lbps_ic_h2_75: Kx=5, Kh=2 (sin-favoring)
- lbps_ic_h5_75: Kx=5, Kh=5 (structured-favoring)
- lbps_ic_h3_50: β_init=0.50 (fast EMA init)
- lbps_ic_h3_90: β_init=0.90 (slow EMA init)
...
CONDS = {
    "lbps_ic_h3_75": make_lbps_ic_h3_75,
    "lbps_ic_h2_75": make_lbps_ic_h2_75,
    "lbps_ic_h5_75": make_lbps_ic_h5_75,
    "lbps_ic_h3_50": make_lbps_ic_h3_50,
    "lbps_ic_h3_90": make_lbps_ic_h3_90,
}
...
def main():
    ...
    parser.add_argument("--out", type=str, default="results/bench_learned_beta_ps_ic_cfc.json")
    ...
    print(f"=== Round 178 LearnedBetaPS+IC-CfC Bench ===")
