"""Round 171 — bench for LearnedPerScaleBeta-CfC (PRD #10-133).

36 cells: 6 conds × 3 datasets × 2 seeds × 30 epochs:
- lb_ps_h3_75: 3-layer, Kx=5, Kh=3, init β=0.75
- lb_ps_h3_50: 3-layer, Kx=5, Kh=3, init β=0.5
- lb_ps_h3_90: 3-layer, Kx=5, Kh=3, init β=0.9
- lb_ps_h2_75: 3-layer, Kx=5, Kh=2, init β=0.75
- lb_ps_h4_75: 3-layer, Kx=5, Kh=4, init β=0.75
- lb_ps_h5_75: 3-layer, Kx=5, Kh=5, init β=0.75
...
# ---------------------------------------------------------------------------
# Data generators (mirror round 165-170)
# ---------------------------------------------------------------------------
...
CONDS = {
    "lb_ps_h3_75": make_lb_ps_h3_75,
    "lb_ps_h3_50": make_lb_ps_h3_50,
    "lb_ps_h3_90": make_lb_ps_h3_90,
    "lb_ps_h2_75": make_lb_ps_h2_75,
    "lb_ps_h4_75": make_lb_ps_h4_75,
    "lb_ps_h5_75": make_lb_ps_h5_75,
}
...
def main():
    ...
    parser.add_argument("--out", type=str, default="results/bench_learned_beta_ps_cfc.json")
    ...
    print(f"=== Round 171 LearnedPerScaleBeta-CfC Bench ===")
    ...
    print(f"Per-scale learnable β (Adam for β), gradient-trained from init values")
