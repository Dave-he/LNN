"""Round 172 — bench for LearnedPerScaleBeta+Schedule-CfC (PRD #10-134).

42 cells: 7 conds × 3 datasets × 2 seeds × 30 epochs:
- lbps_h3_75_const: 3-layer, Kx=5, Kh=3, learnable β, schedule=constant
- lbps_h3_75_linear: 3-layer, Kx=5, Kh=3, learnable β, schedule=linear
- lbps_h3_75_reverse: 3-layer, Kx=5, Kh=3, learnable β, schedule=reverse
- lbps_h2_75_const: 3-layer, Kx=5, Kh=2, learnable β, schedule=constant (round 171 winner)
- lbps_h2_75_reverse: 3-layer, Kx=5, Kh=2, learnable β, schedule=reverse
- lbps_h5_75_const: 3-layer, Kx=5, Kh=5, learnable β, schedule=constant (round 171 winner)
- lbps_h5_75_reverse: 3-layer, Kx=5, Kh=5, learnable β, schedule=reverse
...
# ---------------------------------------------------------------------------
# Data generators (mirror round 165-171)
# ---------------------------------------------------------------------------
...
CONDS = {
    "lbps_h3_75_const": make_lbps_h3_75_const,
    "lbps_h3_75_linear": make_lbps_h3_75_linear,
    "lbps_h3_75_reverse": make_lbps_h3_75_reverse,
    "lbps_h2_75_const": make_lbps_h2_75_const,
    "lbps_h2_75_reverse": make_lbps_h2_75_reverse,
    "lbps_h5_75_const": make_lbps_h5_75_const,
    "lbps_h5_75_reverse": make_lbps_h5_75_reverse,
}
...
def main():
    ...
    parser.add_argument("--out", type=str, default="results/bench_learned_beta_ps_sched_cfc.json")
    ...
    print(f"=== Round 172 LearnedBetaPS+Sched-CfC Bench ===")
